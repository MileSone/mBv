 ...
 */
define(
        ['ojs/ojcore', 'knockout', 'jquery', 'ojs/ojchart', 'jet-composites/demo-chart-three-d-effect-control/loader', 'ojs/ojrouter'], function (oj, ko, $) {
    'use strict';
    ...
    function ExampleComponentModel(context) {
        ...
        self.listener = function () {
            oj.Router.rootInstance.go('caiwu/bankuai');
        }
