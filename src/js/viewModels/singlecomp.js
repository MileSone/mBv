...
define(['ojs/ojcore', 'knockout', 'jquery', 'appController', 'ojs/ojbutton', 'ojs/ojrouter', 'jet-composites/my-bar/loader'],
        function (oj, ko, $, app) {
            ...
            function singlecompContentViewModel() {
                ...
                self.scdata1.push({dataurl: 'js/data/caiwu/income/singlecompany/sincdata_1.json', chartname: '各子公司年累计收款与年计划对比情况'});
                self.scdata2 = ko.observableArray();
                self.scdata2.push({dataurl: 'js/data/caiwu/income/singlecompany/sincdata_2.json', chartname: '月累计收款与月计划对比情况'});
                self.scdata3 = ko.observableArray();
                self.scdata3.push({dataurl: 'js/data/caiwu/income/singlecompany/sincdata_3.json', chartname: '当日收款情况'});
